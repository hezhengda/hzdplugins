...
class deepmdInputGenerator():
    ...
    def setDescriptor_se_a(sel, rcut=6.0, rcut_smth=0.5, neuron=[10, 20, 40], axis_neuron=4, activation_function='tanh', resnet_dt=False, type_one_side=False, precision='float64', trainable=True, seed=1, exclude_types=[], set_davg_zero=False):
    ...
    def setFittingNet(fntype = 'ener', numb_fparam = 0, numb_aparm = 0, neuron = [120, 120, 120], activation_function = 'tanh', precision = 'float64', resnet_dt = True, trainable = True, rcond = 0.001, seed = 1, atom_ener = []):
    ...
    def setTrainingData(systems=['./'], set_prefix='set', batch_size='auto', auto_prob='prob_sys_size', sys_probs=None):
    ...
    def setValidationData(systems=['./'], set_prefix='set', batch_size='auto', auto_prob='prob_sys_size', sys_probs=None, numb_batch=1):
    ...
    def output(self):
        """
        This function can output the current stages of the input file for deepmd-kit
        """
        tmp_dict = {}
